...
public class HelpCommand {
    public static final String MESSAGE_USAGE =
            "-------------------- TRAVELTRIO HELP GUIDE --------------------\n"
                    ...
                    + "13. additem       : Add a new item to your packing list.\n"
                    + "14. listitems     : View all items in your packing list.\n"
                    + "15. checkitem     : Mark an item in your packing list as packed.\n"
                    + "16. deleteitem    : Remove an item from your packing list.\n\n"

                    + "--- Budget Commands (Requires an open trip) ---\n"
                    + "17. setbudget     : Assign a budget to a specific activity.\n"
                    + "18. setexpense    : Set the actual spending for a specific activity that has a budget.\n"
                    + "19. setcurrency   : Update the exchange rate for converting foreign currency expenses to home"
                            + " currency.\n"
                    + "20. budgetsummary : View a breakdown of expenses and remaining budget.\n"
                    + "21. listexpense   : compare budget and actual spending for activities, "
                            + "and show total spending.\n"
                    + "22. setdailylimit : set a daily limit for expenses, warn users when limit exceeds.\n\n"
